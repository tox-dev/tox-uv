...
class UvInstaller(Pip):
    ...
    def post_process_install_command(self, cmd: Command) -> Command:
        ...
        # uv pip command does not have same option named for reinstall and we
        # want to allow users that use original 'pip' in their install_command
        # to still be able to make use of it.
