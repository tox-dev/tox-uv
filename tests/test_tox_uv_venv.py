...
def test_get_python_architecture(base_python: str, architecture: int | None) -> None:
    ...
    python_info = uv_venv._get_python([base_python])
...
def test_env_version_spec_no_architecture() -> None:
    ...
    uv_venv._base_python_searched = True
    uv_venv._base_python = PythonInfo(
...
def test_env_version_spec_architecture_configured_overwrite_sys_exe() -> None:
    uv_venv = _TestUvVenv(create_args=mock.MagicMock())
    uv_venv._base_python_searched = True
